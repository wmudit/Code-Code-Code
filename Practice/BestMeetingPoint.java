...
public class BestMeetingPoint {
	 ...
	 * Distance, where distance(p1, p2) = |p2.x - p1.x| + |p2.y - p1.y| For example,
	 * given three people living at (0,0), (0,4), and (2,2) The point (0,2) is an
	 * ideal meeting point, as the total travel distance of 2+2+2=6 is minimal. So
	 * return 6
	 */
